 ...
 async function handleSubmit(e){
  ...
  return (
    ...
    {!isImageLoaded ? <div className=' flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 rounded-full'>
      ...
      <button className='bg-zinc-900 px-10 sm:px-16 py-3 rounded-full' onClick={(e)=>handleSubmit(e)}>Generate</button>
    </div> : <div className='flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-10 rounded-full'>
      <p className='bg-transparent border border-zinc-900 text-black px-9 py-3 rounded-full cursor-pointer' onClick={()=>{setIsImageLoaded(false)}}>Generate Button</p>
