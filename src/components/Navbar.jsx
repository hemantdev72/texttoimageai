...
import { logout, setShowLogin } from "../redux/slices/userSlice";
      ...
      <div>
        {user ? (
            ...
            <div className="relative group">
              ...
              <div className="absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12">
                <ul className="list-none m-0 p-2 bg-white rounded-md border text-sm">
                  <li className="py-1 px-2 cursor-pointer pr-10" onClick={() => dispatch(logout())}>logout</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 md:gap-5">
            ...
            <button onClick={()=>{dispatch(setShowLogin(true));}} className=" bg-zinc-800 text-white px-7 py-2 sm:px-10 text-sm rounded-full">
              Login
            </button>
          </div>
        )}
